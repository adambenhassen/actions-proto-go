...
type TaskNeed struct {
	...
	Result  string            `protobuf:"bytes,2,opt,name=result,proto3" json:"result,omitempty"`                                                                                           // The result of a job that the current job depends on. Possible values are success, failure, cancelled, or skipped.
}
...
func (x *TaskNeed) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
var file_runner_v1_messages_proto_rawDesc = []byte{
	...
	0x6c, 0x73, 0x22, 0xb2, 0x03, 0x0a, 0x04, 0x54, 0x61, 0x73, 0x6b, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x72, 0x79, 0x52, 0x07, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x73, 0x12, 0x1c, 0x0a, 0x07, 0x6d,
	0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42, 0x02, 0x18, 0x01,
	0x52, 0x07, 0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x12, 0x30, 0x0a, 0x05, 0x6e, 0x65, 0x65,
	0x64, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x72, 0x75, 0x6e, 0x6e, 0x65,
	0x72, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x2e, 0x4e, 0x65, 0x65, 0x64, 0x73, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x05, 0x6e, 0x65, 0x65, 0x64, 0x73, 0x1a, 0x3a, 0x0a, 0x0c, 0x53,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x13, 0x0a, 0x11, 0x5f, 0x77, 0x6f, 0x72, 0x6b, 0x66,
	0x6c, 0x6f, 0x77, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x42, 0x0a, 0x0a, 0x08, 0x5f,
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x22, 0x9a, 0x01, 0x0a, 0x08, 0x54, 0x61, 0x73, 0x6b,
	0x4e, 0x65, 0x65, 0x64, 0x12, 0x3a, 0x0a, 0x07, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x72, 0x75, 0x6e, 0x6e, 0x65, 0x72, 0x2e, 0x76,
	0x31, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x4e, 0x65, 0x65, 0x64, 0x2e, 0x4f, 0x75, 0x74, 0x70, 0x75,
...
var file_runner_v1_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_runner_v1_messages_proto_goTypes = []interface{}{
	...
	nil,                           // 16: runner.v1.Task.SecretsEntry
	nil,                           // 17: runner.v1.Task.NeedsEntry
	nil,                           // 18: runner.v1.TaskNeed.OutputsEntry
...
var file_runner_v1_messages_proto_depIdxs = []int32{
	...
	13, // 3: runner.v1.UpdateTaskResponse.state:type_name -> runner.v1.TaskState
	15, // 4: runner.v1.UpdateLogRequest.rows:type_name -> runner.v1.LogRow
	0,  // 5: runner.v1.Runner.status:type_name -> runner.v1.RunnerStatus
	19, // 6: runner.v1.Task.context:type_name -> google.protobuf.Struct
	16, // 7: runner.v1.Task.secrets:type_name -> runner.v1.Task.SecretsEntry
	17, // 8: runner.v1.Task.needs:type_name -> runner.v1.Task.NeedsEntry
	18, // 9: runner.v1.TaskNeed.outputs:type_name -> runner.v1.TaskNeed.OutputsEntry
	1,  // 10: runner.v1.TaskState.result:type_name -> runner.v1.Result
	20, // 11: runner.v1.TaskState.started_at:type_name -> google.protobuf.Timestamp
	20, // 12: runner.v1.TaskState.stopped_at:type_name -> google.protobuf.Timestamp
	14, // 13: runner.v1.TaskState.steps:type_name -> runner.v1.StepState
	1,  // 14: runner.v1.StepState.result:type_name -> runner.v1.Result
	20, // 15: runner.v1.StepState.started_at:type_name -> google.protobuf.Timestamp
	20, // 16: runner.v1.StepState.stopped_at:type_name -> google.protobuf.Timestamp
	20, // 17: runner.v1.LogRow.time:type_name -> google.protobuf.Timestamp
	12, // 18: runner.v1.Task.NeedsEntry.value:type_name -> runner.v1.TaskNeed
